...
public class SQL extends ZSQL {
	...
	public SQL(ZPort instance, String h, String d, String u, String p,
			int prt) {
	...
	protected void createDefaultTables() {
		this.prepared("CREATE TABLE IF NOT EXISTS zp_warps("
				+ "id INT(5) PRIMARY KEY AUTO_INCREMENT, "
				+ "date_created LONG NOT NULL DEFAULT 0, "
				+ "last_used LONG NOT NULL DEFAULT 0, "
				+ "total_uses INT(6) NOT NULL DEFAULT 0, "
				+ "name VARCHAR(16) UNIQUE KEY NOT NULL DEFAULT '', "
				...
				+ "world VARCHAR(16) NOT NULL DEFAULT '') ENGINE=InnoDB;", new Object[]{});
		this.prepared("CREATE TABLE IF NOT EXISTS zp_homes("
				+ "id INT(5) PRIMARY KEY AUTO_INCREMENT, "
				+ "owner VARCHAR(16) NOT NULL DEFAULT '', "
				+ "x DOUBLE NOT NULL DEFAULT 0.0, "
				+ "y DOUBLE NOT NULL DEFAULT 0.0, "
				...
				+ "pitch FLOAT NOT NULL DEFAULT 0.0, "
				+ "world VARCHAR(16) NOT NULL DEFAULT '') ENGINE=InnoDB;", new Object[]{});
		this.prepared("CREATE TABLE IF NOT EXISTS zp_signs("
				+ "id INT(5) PRIMARY KEY AUTO_INCREMENT, "
				+ "date_created LONG NOT NULL DEFAULT 0, "
				+ "last_used LONG NOT NULL DEFAULT 0, "
				+ "total_uses INT(6) NOT NULL DEFAULT 0, "
